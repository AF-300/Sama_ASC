...
class JoueurController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'categorie' => 'required|in:senior,cadet',
        ]);
        ...
        return redirect()->route('joueurs.index')
            ->with('success', 'Joueur ajoute avec succes.');
    }
    ...
    public function update(Request $request, Joueur $joueur)
    {
        ...
        return redirect()->route('joueurs.index')
            ->with('success', 'Joueur mis a jour avec succes.');
    }
    ...
    public function destroy(Joueur $joueur)
    {
        ...
        return redirect()->route('joueurs.index')
            ->with('success', 'Joueur supprime avec succes.');
    }

    public function compresserEtStockerPhoto($fichier): string
    {
